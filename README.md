...
3. **Codebase utility.** `/codegraph-build` builds a polyglot code graph using tree-sitter (TS/JS/Python scaffold landed PR 4; real parsers wiring in PR 5/6). Storage is **Turso/libSQL**.
