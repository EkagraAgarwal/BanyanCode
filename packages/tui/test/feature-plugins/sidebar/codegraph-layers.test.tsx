...
import SidebarCodegraphLayers from "../../../src/feature-plugins/sidebar/codegraph-layers"
...
describe("sidebar codegraph-layers", () => {
  test("sidebar_content slot renders without throwing", async () => {
    ...
    const Inner = () => {
      ...
      void SidebarCodegraphLayers.tui(api as any, undefined as any, { id: "test" } as any)
