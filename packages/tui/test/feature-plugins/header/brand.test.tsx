...
import HeaderBrand from "../../../src/feature-plugins/header/brand"
...
test("header brand app_top slot renders without throwing", async () => {
  ...
  const Inner = () => {
    ...
    void HeaderBrand.tui(api as any, undefined as any, { id: "test" } as any)
