...
import defaultSoundPath from "@opencode-ai/tui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@opencode-ai/tui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@opencode-ai/tui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@opencode-ai/tui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@opencode-ai/tui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@opencode-ai/tui/audio/yup-01.mp3" with { type: "file" }
