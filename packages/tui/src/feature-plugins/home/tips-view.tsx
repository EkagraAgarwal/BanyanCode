...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/lsp{/highlight} to toggle BanyanCode's LSP servers",
  ...
  'Set {highlight}"banyancode_lsp": true{/highlight} in {highlight}banyancode.json{/highlight} to enable built-in LSP servers for code analysis',
