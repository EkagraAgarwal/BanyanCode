...
export const POLICY_TEXT = [
  ...
  "intelligence tools are the canonical search surface. `grep`, `glob`,",
  "`bash`, and raw `read` are PRIMITIVES — they are fallbacks, not",
  "defaults. You do not get to choose between them: for source-code",
  "questions, the first search operation MUST be a repository",
  "intelligence tool.",
  "",
