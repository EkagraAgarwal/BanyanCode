...
Consumers in `packages/opencode` use the namespace form: `Banyan.CodegraphBuildService`, `Banyan.CodegraphRepo`, etc. Direct imports (`import { X } from "@opencode-ai/core/banyancode/x"`) are used in core to avoid the namespace import.
