...
export function createRoutes(
  ...
  return Layer.mergeAll(
    ...
    Layer.provide([
      ...
      Banyan.systemMonitorDefaultLayer as unknown as Layer.Layer<never, never, never>,
      Banyan.codegraphBuildServiceDefaultLayer as unknown as Layer.Layer<never, never, never>,
      Banyan.codegraphEmbedderDefaultLayer as unknown as Layer.Layer<never, never, never>,
      Banyan.embeddingProviderDefaultLayer as unknown as Layer.Layer<never, never, never>,
    ]),
