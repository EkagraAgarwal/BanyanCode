...
const mockCodegraphRepoLayer = Layer.succeed(Banyan.CodegraphRepo, Banyan.CodegraphRepo.of({
  ...
  searchNodes: () => Effect.succeed([]) as any,
  countNodes: () => Effect.succeed(0) as any,
  countEdges: () => Effect.succeed(0) as any,
  countFiles: () => Effect.succeed(0) as any,
  putEdge: () => Effect.void as any,
    putEdges: () => Effect.void as any,
    putNodes: () => Effect.void as any,
