...
# output: dist/banyancode-<platform>-<arch>/bin/banyancode[.exe]
```
...
# macOS / Linux
install -d ~/.local/bin
install -m 0755 dist/banyancode-darwin-arm64/bin/banyancode ~/.local/bin/
```
