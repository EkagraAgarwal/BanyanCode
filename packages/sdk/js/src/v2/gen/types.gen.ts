    ...
    | {
        [key: string]:
          ...
          | {
              ...
              maxMemoryMb?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
...
export type BanyanConfig = {
  ...
  banyancode_agent_telemetry?: "on" | "off"
  banyancode_agent_telemetry_retention_days?:
    | number
    | "NaN"
    | "Infinity"
    | "-Infinity"
    ...
    | "-Infinity"
    | "NaN"
  banyancode_agent_telemetry_max_events?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
   ...
   */
  banyancode_lsp_idle_timeout_ms?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
...
export type BanyanMemoryScope = string

export type BanyanMemoryListInput = {
...
export type BanyanMemoryPayloadV1 = {
  kind:
    | "preference"
    | "identity"
    | "convention"
  ...
  symbolRefs?: Array<string>
  supersedes?: string
  supersededBy?: string
  lastReferencedAt?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
  retrievalCount?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
}

export type BanyanMemoryEnvelopeV1 = {
  _v: 1
  data: BanyanMemoryPayloadV1
}

export type BanyanMemoryEntry = {
  id: string
  key: string
  value: unknown
  envelope?: BanyanMemoryEnvelopeV1
  context?: string
  tags: Array<string>
  scope: "global" | "session"
  sessionID?: string
...
export type BanyanMemoryId = string

export type BanyanMemoryGetInput = {
  id: BanyanMemoryId
}

export type BanyanMemoryKey = string

export type BanyanMemoryRecallInput = {
  key: BanyanMemoryKey
  scope?: BanyanMemoryScope
  sessionID?: string
}

export type BanyanMemorySearchInput = {
  query: string
  limit?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
  scope?: BanyanMemoryScope
  sessionID?: string
...
export type BanyanMemorySearchResult = {
  entries: Array<BanyanMemoryEntry>
  totalHits: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
  degraded: boolean
}

export type BanyanMemoryStoreInput = {
  id?: BanyanMemoryId
  key: BanyanMemoryKey
  value: unknown
  envelope?: BanyanMemoryEnvelopeV1
...
export type BanyanMemoryStoreResult = {
  id: string
  version: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
}

export type BanyanMemoryForgetInput = {
  id?: BanyanMemoryId
  key?: BanyanMemoryKey
  scope?: BanyanMemoryScope
  sessionID?: string
...
export type BanyanMemoryForgetResult = {
  removed: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
}

export type BanyanMemoryCandidatesInput = {
  status?: "pending" | "active" | "superseded" | "rejected" | "expired"
  scope?: BanyanMemoryScope
  limit?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
}

export type BanyanMemoryCandidatesResult = {
  entries: Array<BanyanMemoryEntry>
  count: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
}

export type BanyanMemoryPromoteInput = {
  id: BanyanMemoryId
...
export type BanyanMemoryPromoteResult = {
  id: string
  key: string
  status: "active"
  version: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
...
export type BanyanMemoryRejectInput = {
  id: BanyanMemoryId
  expectedVersion: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
}

export type BanyanMemoryRejectResult = {
  id: string
  status: "rejected"
  version: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
}
...
export type LspStatus = {
  ...
  /**
   * Attached clients for this server (1 for a connected entry, 0 otherwise).
   */
  clientCount?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
  /**
   * Best-effort process-tree RSS in bytes for the attached client.
   */
  rssBytes?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
  /**
   * OS pid of the attached language server process.
   */
...
export type EventBanyancodeMemoryCandidateEmitted = {
  id: string
  type: "banyancode.memory.candidate_emitted"
  properties: {
    id: string
...
export type EventBanyancodeMemoryPromoted = {
  id: string
  type: "banyancode.memory.promoted"
  properties: {
    id: string
...
export type EventBanyancodeMemoryRejected = {
  id: string
  type: "banyancode.memory.rejected"
  properties: {
    id: string
...
export type GlobalProviderUsageListData = {
  body?: never
  path?: never
  query?: never
  url: "/global/provider-usage"
}

export type GlobalProviderUsageListErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type GlobalProviderUsageListError = GlobalProviderUsageListErrors[keyof GlobalProviderUsageListErrors]

export type GlobalProviderUsageListResponses = {
  /**
   * Cached provider usage snapshots
   */
  200: {
    snapshots: Array<{
      providerID: string
      ...
      message?: string
      fetchedAt: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
    }>
  }
}

export type GlobalProviderUsageListResponse = GlobalProviderUsageListResponses[keyof GlobalProviderUsageListResponses]

export type GlobalProviderUsageRefreshData = {
  body?: {
    /**
     * Provider identifier (letters, digits, '.', '_', '-' only)
     */
    providerID?: string
  }
  path?: never
...
export type GlobalProviderUsageRefreshErrors = {
  /**
   * BadRequest | InvalidRequestError
   */
  400: EffectHttpApiErrorBadRequest | InvalidRequestError
...
export type GlobalProviderUsageRefreshError = GlobalProviderUsageRefreshErrors[keyof GlobalProviderUsageRefreshErrors]

export type GlobalProviderUsageRefreshResponses = {
  /**
   * Refreshed provider usage snapshots
   */
  200: {
    snapshots: Array<{
      providerID: string
...
export type GlobalProviderUsageRefreshResponse =
  GlobalProviderUsageRefreshResponses[keyof GlobalProviderUsageRefreshResponses]
...
export type MemoryRecallResponses = {
  /**
   * Memory entries for key
   */
  200: Array<BanyanMemoryEntry>
}

export type MemoryRecallResponse = MemoryRecallResponses[keyof MemoryRecallResponses]

export type MemorySearchData = {
  body?: BanyanMemorySearchInput
  path?: never
  query?: never
...
export type MemoryForgetResponses = {
   ...
   * Forget result
   */
  200: BanyanMemoryForgetResult
}

export type MemoryForgetResponse = MemoryForgetResponses[keyof MemoryForgetResponses]

export type MemoryCandidatesData = {
  body?: BanyanMemoryCandidatesInput
  path?: never
  query?: never
  url: "/global/memory/candidates"
}

export type MemoryCandidatesErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type MemoryCandidatesError = MemoryCandidatesErrors[keyof MemoryCandidatesErrors]

export type MemoryCandidatesResponses = {
  /**
   * Candidate memory entries
   */
  200: BanyanMemoryCandidatesResult
}

export type MemoryCandidatesResponse = MemoryCandidatesResponses[keyof MemoryCandidatesResponses]

export type MemoryPromoteData = {
  body?: BanyanMemoryPromoteInput
  path?: never
  query?: never
  url: "/global/memory/promote"
}
