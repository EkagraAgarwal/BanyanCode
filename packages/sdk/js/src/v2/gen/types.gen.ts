...
export type BanyanCodegraphNode = {
    id: string;
    fileID: string;
    kind: 'file' | 'function' | 'class' | 'method' | 'type' | 'variable' | 'test' | 'route' | 'config' | 'build' | 'package' | 'generated' | 'ci' | 'docker' | 'env' | 'doc';
    name: string;
    signature?: string;
...
export type BanyanCodegraphEdge = {
    ...
    fromNodeID: string;
    toNodeID: string;
    kind: 'imports' | 'calls' | 'extends' | 'references' | 'tested_by' | 'configured_by' | 'built_by' | 'mounts' | 'generated_from';
};
...
export type BanyanMemoryListInput = {
    ...
    sessionID?: string;
    prefix?: string;
    kind?: 'preference' | 'identity' | 'convention' | 'decision' | 'architecture' | 'pattern' | 'warning' | 'failure' | 'todo' | 'observation' | 'summary' | 'ownership' | 'constraint' | 'environment';
...
export type GlobalBanyanConfigUpdateResponse = GlobalBanyanConfigUpdateResponses[keyof GlobalBanyanConfigUpdateResponses];
...
export type GlobalCodegraphForceKillResponse = GlobalCodegraphForceKillResponses[keyof GlobalCodegraphForceKillResponses];
...
export type RepositoryIntelRelationshipsError = RepositoryIntelRelationshipsErrors[keyof RepositoryIntelRelationshipsErrors];
...
export type RepositoryIntelRelationshipsResponse = RepositoryIntelRelationshipsResponses[keyof RepositoryIntelRelationshipsResponses];
...
export type RepositoryIntelOwnershipResponse = RepositoryIntelOwnershipResponses[keyof RepositoryIntelOwnershipResponses];
...
export type RepositoryIntelArchitecturalSliceError = RepositoryIntelArchitecturalSliceErrors[keyof RepositoryIntelArchitecturalSliceErrors];
...
export type RepositoryIntelArchitecturalSliceResponse = RepositoryIntelArchitecturalSliceResponses[keyof RepositoryIntelArchitecturalSliceResponses];
